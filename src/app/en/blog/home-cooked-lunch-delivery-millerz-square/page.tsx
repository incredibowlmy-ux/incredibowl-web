...
// 英文版博客：镜像 /blog/home-cooked-lunch-delivery-millerz-square，事实（截单
// 时间、运费档位、覆盖区）全部同源 deliveryCopy 常量或照原文直译，无新增主张。

export const metadata: Metadata = {
  title:
    "Home-Cooked Lunch Delivery Near Millerz Square | MSG-Free Workday Lunch — Incredibowl",
  description:
    "Home-cooked lunch delivery near Millerz Square, Old Klang Road. No MSG, freshly sourced every morning, real protein portions. Order by 6AM, delivered from 11AM.",
  alternates: {
    canonical:
      "https://www.incredibowl.my/en/blog/home-cooked-lunch-delivery-millerz-square",
    languages: {
  ...
  openGraph: {
    ...
    description:
      "MSG-free home-cooked lunch delivery near Millerz Square / Old Klang Road. Order by 6AM, delivered from 11AM.",
    url: "https://www.incredibowl.my/en/blog/home-cooked-lunch-delivery-millerz-square",
...
export default function HomeCookedLunchDeliveryMillerzSquareEN() {
  const articleSchema = {
    "@context": "https://schema.org",
    "@type": "Article",
    headline:
      "Home-Cooked Lunch Delivery Near Millerz Square: A Workday Lunch That Is Not Fried Again",
    description:
  ...
  const faqSchema = {
    ...
    mainEntity: [
      ...
      {
        "@type": "Question",
        name: "How much is delivery to Millerz Square?",
        acceptedAnswer: {
          "@type": "Answer",
          text: `From Pearl Point: ${tierProseEn(TIER_INNER)}, ${tierProseEn(TIER_OUTER)}. Millerz Square is right next to Pearl Point, so it falls in the nearest delivery tier. The delivery zone covers ${COVERAGE_AREAS.join(", ")}. After you register and enter your address, the system automatically checks the actual distance and fee.`,
        },
      },
    ],
  };
      ...
      <div className="max-w-3xl mx-auto px-6 py-12 md:py-16">
        ...
        <header className="mb-10">
          ...
          <h1 className="text-3xl md:text-5xl font-black leading-tight mb-4">
            Home-Cooked Lunch Delivery Near Millerz Square: A Better Option for Office Workers
          </h1>
        </header>
        ...
        <div className="relative aspect-[16/9] rounded-2xl overflow-hidden mb-10 bg-[#E3EADA]">
          <Image
            ...
            alt="Home-cooked lunch delivery near Millerz Square - Incredibowl potato fried egg home-style lunch"
            fill
        ...
        <div className="mb-10 p-5 md:p-6 bg-[#E3EADA]/50 border-l-4 border-[#FF6B35] rounded-r-2xl">
          ...
          <p className="text-[15px] md:text-[16px] leading-relaxed text-[#1A2D23]/85">
            ...
            and lunch arrives from 11AM. MSG-free home-cooked lunch · next to Millerz Square · {tierProseEn(TIER_INNER)}.
          </p>
        </div>

        <div className="prose prose-lg max-w-none space-y-6 leading-relaxed text-[#1A2D23]/85 text-[16px] md:text-[17px]">
          <p>
            <strong>Millerz Square</strong> is one of the busier developments on Old Klang Road — plenty of residents, office workers and businesses. When lunchtime rolls around and you want something hot, the usual options are the food court downstairs or a fast-food chain on GrabFood — and after a while, it all feels either too oily or too salty.
          </p>
          <p>
            This piece walks through how to get a <strong>freshly cooked, MSG-free home-cooked lunch</strong> around Millerz Square.
          </p>
          ...
          <p>
            <Link href="/en" className="text-[#FF6B35] font-bold hover:underline">Incredibowl</Link> (BowlMama's kitchen) cooks out of a home kitchen at Pearl Point, right next to Millerz Square:
          </p>
          <ul className="list-disc pl-6 space-y-2">
            ...
            <li>It's close by, so lunch arrives fast and the delivery fee is in the lowest tier.</li>
          </ul>
          ...
          <div className="space-y-5">
            ...
            <div>
              <h3 className="font-black text-lg mb-1">Q: How much is delivery to Millerz Square?</h3>
              <p>From Pearl Point: {tierProseEn(TIER_INNER)}, {tierProseEn(TIER_OUTER)}. Millerz Square is right next to Pearl Point, in the nearest tier. The delivery zone covers {COVERAGE_AREAS.join(", ")}. After you register and enter your address, the system checks automatically.</p>
            </div>
          </div>
          ...
          <div className="mt-16 p-6 md:p-8 bg-[#FF6B35]/8 border-2 border-[#FF6B35]/20 rounded-2xl text-center">
            ...
            <p className="text-[#1A2D23]/70 mb-5 text-sm md:text-base">
              Next to Millerz Square · no MSG · wet-market fresh daily · orders close 6AM · delivered from 11AM
            </p>
            <Link
              href="/en"
