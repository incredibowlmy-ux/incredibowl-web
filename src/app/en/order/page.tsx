...
export const metadata: Metadata = {
    ...
    description:
        "6 AM market run · lunch (11:30 AM) or dinner (5 PM) delivery. From RM 16.90, free delivery from RM 20+ (within 5 km). One WhatsApp to order — no signup. Pearl Point / Old Klang Road / OUG.",
    alternates: {
        canonical: "/en/order",
        languages: {
            "zh-MY": "/order",
