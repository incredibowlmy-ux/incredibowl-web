...
const tierWaMsg = (r: DeliveryResult, addr: string) => {
    ...
    if (r.tier === "near") {
        return `Hi BowlMama! I came from your FB ad. My address: ${a} (within 5 km · RM 5, free over RM 20-30 ✓). I'd like to see today's / tomorrow's menu 🔥`;
    }
    if (r.tier === "outside") {
            ...
            <section className="relative px-5 pt-10 pb-10 lg:pt-16 lg:pb-14 overflow-hidden">
                ...
                <div className="relative max-w-md lg:max-w-2xl mx-auto">
                    ...
                    <p className="text-base lg:text-lg text-[#1A2D23]/60 font-bold mb-7">
                        <span className="text-[#1A2D23] font-black">From RM 16.90</span> · Free from RM 20+ · Fresh-cooked
                    </p>
