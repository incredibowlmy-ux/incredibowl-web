...
export const metadata: Metadata = {
  ...
  description: "吉隆坡 Old Klang Road 私厨外送。不加味精，每天巴刹新鲜现煮。Pearl Point 出发，Old Klang Road / OUG 一带 2.5km 内 RM 5（满 RM 20 免运）· 2.5–5km RM 5（满 RM 30 免运）。早上 6AM 截单。www.incredibowl.my",
  alternates: {
    canonical: "/",
    languages: {
      "zh-MY": "/",
  ...
  openGraph: {
    ...
    description: "不加味精，每天巴刹新鲜现煮。Pearl Point 出发，2.5km 内 RM 5（满 RM 20 免运）· 2.5–5km RM 5（满 RM 30 免运）。",
            ...
            __html: JSON.stringify({
              ...
              "@graph": [
                ...
                },
                {
                  ...
                  description: "吉隆坡 Old Klang Road 私厨外送。不加味精，每天巴刹新鲜现煮。Pearl Point 出发，Old Klang Road / OUG 一带 2.5km 内 RM 5（满 RM 20 免运）· 2.5–5km RM 5（满 RM 30 免运）。",
                  url: "https://www.incredibowl.my/",
