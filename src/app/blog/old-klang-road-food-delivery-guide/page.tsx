  ...
  const faqSchema = {
    ...
    mainEntity: [
      ...
      },
      {
        ...
        acceptedAnswer: {
          "@type": "Answer",
          text: "Pearl Point 出发，2km 内免运（覆盖 Pearl Point、Millerz Square、Meadow Park、The Scott Garden 等）。2km 外配送费 RM6，但折后满 RM40 即可免运。",
        },
      },
      {
        "@type": "Question",
    ...
    <article className="min-h-screen bg-[#FDFBF7] text-[#1A2D23]">
      ...
      <div className="max-w-3xl mx-auto px-6 py-12 md:py-16">
        ...
        <div className="prose prose-lg max-w-none space-y-6 leading-relaxed text-[#1A2D23]/85 text-[16px] md:text-[17px]">
          ...
          <p className="mt-4">
            <strong>运费规则</strong>：2km 内免运，2km 外 RM6（折后满 RM40 自动免运）。每日早上 6AM 截单。
          </p>
          ...
          <div className="space-y-5">
            ...
            <div>
              ...
              <p>Pearl Point 出发，2km 内免运（涵盖 Old Klang Road 中段绝大部分公寓）。2km 外 RM6，折后满 RM40 自动免运。</p>
            </div>
            <div>
