    ...
    return (
        <div className="min-h-screen bg-[#F7F9F9] font-sans text-[#2D3142]">
            ...
            <nav className="p-8 max-w-7xl mx-auto flex justify-between items-center">
                <Link href="/v0-8" className="flex items-center gap-4 group">
                    ...
                    <div className="space-y-6">
                            ...
                            <div key={order.id} className="bg-white rounded-[48px] p-10 border border-gray-100 hover:border-[#4F6D7A]/20 transition-all group overflow-hidden relative">
                                ...
                                <div className="relative z-10 space-y-10">
                                    ...
                                    <div className="flex flex-col md:flex-row gap-8 items-end justify-between">
                                        ...
                                        <Link href={`/v0-8`} className="flex-shrink-0 flex items-center gap-4 text-[10px] font-black uppercase tracking-[0.3em] text-[#4F6D7A] hover:gap-6 transition-all">
                        ...
                        {orders.length === 0 && (
                            <div className="bg-white rounded-[48px] p-24 text-center space-y-6 border border-dashed border-gray-200">
                                ...
                                <Link href="/v0-8" className="inline-block px-12 py-5 bg-[#4F6D7A] text-white rounded-full font-black text-sm uppercase tracking-widest shadow-xl shadow-[#4F6D7A]/10">Browse Marketplace</Link>
                            </div>
                        )}
                    </div>
                </div>
