...
export const ADD_ON_PRICES: Record<string, number> = {
  ...
  // 老板 2026-07-31 更正口径：RM 5.225 是「半片」的进价（不是整片），
  // 即主菜每份自带的那 0.5 片就值 RM 5.225，整片 RM 10.45。
  // 按成本表 v5 自己的定价公式「建议售价 = 成本 ÷ 33%」= RM 15.83 → 取 15.90。
  // 对照加三文鱼：18.50 ÷ 成本 6.00 = 3.08×，本项 15.90 ÷ 5.225 = 3.04×，同一档。
  'extra-unagi-half': 15.90,
