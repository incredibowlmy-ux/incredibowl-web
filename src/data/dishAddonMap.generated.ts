...
export const DISH_ADDONS_BY_NAME: Record<string, DishAddonOption[]> = {
  ...
  "阿嫲古早味酱油鸡全腿": [
    {
      "id": "soy-chicken-rice-king-combo",
      "label": "酱香下饭套",
      "price": 12.9
    },
    {
      "id": "soy-chicken-rice-combo",
      "label": "酱油鸡干饭套",
      "price": 5.9
    },
    {
  ...
  "家乡白萝卜焖花肉": [
    {
      "id": "daikon-rice-king-combo",
      "label": "萝卜下饭套",
      "price": 12.9
    },
    {
      "id": "daikon-rice-combo",
      "label": "萝卜干饭套",
      "price": 7
    },
    {
...
export const DEFAULT_ADDON_OPTIONS: DishAddonOption[] = [
  {
    "id": "less-rice",
    "label": "少饭",
    "price": 0
