...
export const addOnRecipes: Record<string, IngredientLine[]> = {
  ...
  // 老板 2026-08-09 确认：标签上的 90g 是**焖后熟重**，采购按 120g 生萝卜记
  //（缩水约 25%，与马铃薯 90→100g、柠香鸡胸 150→170g 同样是「宁多勿少」口径）。
  // ⚠️ 主菜本身自带多少白萝卜仍未知（dishRecipes 里 30 号还是空数组，五花肉/
  // 白饭/姜葱的克数碗妈都没给），所以备餐汇总目前只算得出加料这部分。
  '【清甜解腻】加白萝卜 (90g)': [{ name: '白萝卜', qty: 120, unit: 'g' }],
