            ...
            <div className="lg:col-span-7 bg-[#E3EADA] rounded-[32px] p-8 md:p-12 relative overflow-hidden flex flex-col justify-end min-h-[460px]">
                ...
                <div className="relative z-20 max-w-xl lg:max-w-2xl">
                    ...
                    <div className="flex flex-wrap items-center gap-3">
                        ...
                        <a
                            href="https://wa.me/60103370197?text=Hi%20%E7%A2%97%E5%A6%88%EF%BC%81%E6%88%91%E6%83%B3%E4%BA%86%E8%A7%A3%E4%B8%80%E4%B8%8B%E4%BB%8A%E5%A4%A9%E7%9A%84%E8%8F%9C%E5%8D%95%E3%80%82"
                            target="_blank"
                        ...
                        >
                            ...
                            <span lang="zh">WhatsApp 问碗妈</span>
                        </a>
                    </div>
                    ...
                    <div className="mt-5 max-w-md lg:max-w-xl">
                        ...
                        <div className="flex flex-wrap items-center gap-x-2.5 gap-y-1 text-[13px] md:text-sm font-bold text-[#1A2D23]/75 lg:hidden">
                            ...
                            <span>2km 内 RM 3（满 20 免运）· 2–5km 满 30 免运</span>
                        </div>
                        ...
                        <div className="hidden lg:flex flex-wrap items-center gap-x-3.5 gap-y-1.5 text-sm font-bold text-[#1A2D23]/75">
                            ...
                            <span className="inline-flex items-center gap-1.5">
                                ...
                                2km 内 RM 3（满 20 免运）· 2–5km 满 30 免运
                            </span>
                        </div>
                        <p className="text-[13px] md:text-sm font-medium text-[#1A2D23]/55 mt-1.5 leading-relaxed">
                            Within 2km RM 3 (free over RM 20) · 2–5km free over RM 30
                        </p>
                    </div>
                </div>
            </div>
