...
export default function HeroSection({ locale }: { locale: Locale }) {
    ...
    return (
        <>
            ...
            <div className="lg:col-span-7 bg-line rounded-[32px] p-8 md:p-12 relative overflow-hidden flex flex-col justify-end min-h-[460px]">
                ...
                <div className="absolute inset-0 pointer-events-none">
                    ...
                    <div className="absolute inset-0 bg-gradient-to-r from-line from-30% via-line/85 via-60% to-line/40 z-10" />
                    <div className="absolute inset-0 bg-gradient-to-t from-line via-line/20 to-transparent z-10" />
                </div>
                ...
                <div className="relative z-20 max-w-xl lg:max-w-2xl">
                    ...
                    <div className="flex flex-wrap items-center gap-2 mb-6">
                        {/* Location badge */}
                        <div className="inline-flex items-center gap-2 px-3 py-1 bg-white/70 backdrop-blur-md rounded-full text-xs font-bold text-ink shadow-sm">
                            <MapPin size={12} className="text-primary" />
                            <span>{t.locationBadge}</span>
                            <span className="text-ink/40">·</span>
                            <span className="text-ink/70">{t.locationSub}</span>
                        </div>
                        {/* Social proof badge → scrolls to feedback section */}
                        <button
                            type="button"
                            onClick={() => document.getElementById('feedback')?.scrollIntoView({ behavior: 'smooth' })}
                            className="inline-flex items-center gap-1.5 px-3 py-1 bg-primary/15 text-[#C84518] rounded-full text-xs font-bold shadow-sm hover:bg-primary/25 transition-colors active:scale-95"
                        >
                    ...
                    {locale === 'en' ? (
                        <>
                            <h1 className="text-4xl md:text-6xl font-extrabold leading-[1.05] tracking-tight mb-2 text-ink drop-shadow-[0_1px_0_rgba(255,255,255,0.6)]">
                                Home-cooked taste,<br />
                                sourced fresh daily.
                            </h1>
                            <p lang="zh" className="text-base md:text-lg font-bold text-ink/65 tracking-wide mb-8">
                                家的味道，每天新鲜采购
                            </p>

                            <p className="text-2xl md:text-3xl font-black text-ink/95 leading-snug tracking-tight mb-3 max-w-md lg:max-w-xl">
                                At the market by <span className="text-primary">6 AM</span>,<br className="md:hidden" />
                                at your door by noon.
                            </p>
                            <p lang="zh" className="text-[13px] md:text-sm font-semibold text-ink/55 leading-relaxed mb-8 max-w-md lg:max-w-xl">
                                凌晨 6 点去巴刹，中午送到你手上
                            </p>
                        </>
                    ) : (
                        <>
                            <h1 lang="zh" className="text-4xl md:text-6xl font-extrabold leading-[1.05] tracking-tight mb-6 text-ink drop-shadow-[0_1px_0_rgba(255,255,255,0.6)]">
                                家的味道，<br />
                                每天新鲜采购。
                            </h1>

                            {/* Action-anchored sub-headline — promoted from body copy to bridge brand slogan ↔ CTA */}
                            <p lang="zh" className="text-2xl md:text-3xl font-black text-ink/95 leading-snug tracking-tight mb-7 max-w-md lg:max-w-xl">
                                凌晨 <span className="text-primary">6 点</span>去巴刹，<br className="md:hidden" />
                                中午送到你手上。
                            </p>
                        </>
                    )}
                    ...
                    <div className="flex flex-wrap items-center gap-3">
                        ...
                        <div className="relative inline-block group">
                            <div className="absolute -inset-1 bg-gradient-to-r from-primary/60 to-[#FF9B50]/60 rounded-full blur-md opacity-70 group-hover:opacity-100 transition duration-500 animate-breathe" />
                            <button
                                type="button"
                                onClick={scrollToMenu}
                                className={locale === 'en'
                                    ? "relative inline-flex items-center gap-3 pl-7 pr-3 py-3 bg-primary hover:bg-primary-dark text-white rounded-full font-black text-base md:text-lg shadow-xl shadow-primary/30 transition-[transform,background-color,box-shadow] duration-200 ease-out transform group-hover:-translate-y-0.5 active:scale-[0.97] active:brightness-95"
                                    : "relative inline-flex items-center gap-3 pl-8 pr-3 py-3.5 bg-primary hover:bg-primary-dark text-white rounded-full font-black text-base md:text-lg shadow-[0_10px_28px_-8px_rgba(255,107,53,0.55)] hover:shadow-[0_14px_32px_-6px_rgba(255,107,53,0.65)] transition-[transform,background-color,box-shadow] duration-200 ease-out transform group-hover:-translate-y-0.5 hover:scale-[1.02] active:scale-[0.97] active:brightness-95"}
                            >
                                {locale === 'en' ? (
                                ...
                                <span className="w-10 h-10 md:w-11 md:h-11 rounded-full bg-white flex items-center justify-center text-primary shadow-md">
                        ...
                        <a
                            ...
                            className="inline-flex items-center gap-2 px-5 py-2.5 bg-transparent border-2 border-ink/15 hover:border-ink/35 hover:bg-white/40 text-ink rounded-full font-bold text-sm transition-[transform,border-color,background-color] duration-150 ease-out active:scale-[0.97]"
                        >
                        ...
                        <Link
                            ...
                            className="hidden lg:inline-flex items-center gap-2 px-5 py-2.5 bg-white/50 border-2 border-primary/25 hover:border-primary/60 hover:bg-white/70 text-ink rounded-full font-bold text-sm transition-[transform,border-color,background-color] duration-150 ease-out active:scale-[0.97]"
                        >
            ...
            <div className="lg:col-span-5">
                <button
                    type="button"
                    onClick={scrollToMenu}
                    className="group w-full text-left bg-white rounded-[32px] overflow-hidden shadow-lg shadow-ink/5 border border-ink/5 hover:shadow-2xl hover:shadow-primary/10 hover:-translate-y-1 transition-[transform,box-shadow] duration-300 ease-out active:scale-[0.99] flex flex-col h-full min-h-[460px]"
                >
                    {/* Image area */}
                    <div className="relative w-full h-56 md:h-64 lg:h-72 overflow-hidden bg-line">
                        {nextSpecial && (
                        ...
                        <div className="absolute top-4 left-4 z-10">
                            <div className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-ink text-white rounded-full shadow-md">
                        ...
                        {nextSpecial && (
                            <div className="absolute bottom-3 right-3 z-10">
                                <span className="inline-block px-2.5 py-1 bg-white/90 backdrop-blur-sm text-ink rounded-full text-xs font-black tracking-wide shadow-md">
                    ...
                    <div className="flex-1 p-6 md:p-7 flex flex-col">
                        ...
                        {locale === 'en' ? (
                            <>
                                <h2 className="text-xl md:text-2xl font-black text-ink leading-tight mb-1">
                                    {nextSpecial?.dish.nameEn ?? signatureDish.nameEn}
                                </h2>
                                <p lang="zh" className="text-xs md:text-sm font-semibold text-ink/55 italic mb-4">
                            ...
                            <>
                                ...
                                <p className="text-xs md:text-sm font-semibold text-ink/55 italic mb-4">
                                    {nextSpecial?.dish.nameEn ?? signatureDish.nameEn}
                                </p>
                            </>
                        )}
                        ...
                        {nextSpecial && (
                            <div className="flex flex-wrap gap-1.5 mb-4">
                                {(locale === 'en' ? (nextSpecial.dish.tagsEn ?? nextSpecial.dish.tags) : nextSpecial.dish.tags).slice(0, 3).map((tag, i) => (
                                    <span key={i} className="px-2.5 py-1 bg-line text-ink/85 rounded-full text-xs font-bold">
                                        {tag}
                                    </span>
                                ))}
                            </div>
                        ...
                        {locale === 'en' ? (
                            nextSpecial?.dish.descEn && (
                                <p className="hidden lg:block text-[13px] text-ink/65 leading-relaxed italic mb-5 line-clamp-3">
                        ...
                        <div className="mt-auto flex items-end justify-between pt-3 border-t border-ink/8 lg:hidden">
                            <p className="text-2xl md:text-3xl font-black text-primary tracking-tight leading-none">
                                RM {finalPrice.toFixed(2)}
                            </p>
                            <div className="w-11 h-11 rounded-full bg-ink flex items-center justify-center text-white group-hover:bg-primary group-hover:scale-110 transition-[transform,background-color] duration-300 ease-out shrink-0">
                        ...
                        <div className="hidden lg:flex mt-auto flex-col gap-3.5 pt-3 border-t border-ink/8">
                            <p className="text-3xl font-black text-primary tracking-tight leading-none">
                                RM {finalPrice.toFixed(2)}
                            </p>
                            <span className="w-full inline-flex items-center justify-center gap-2 px-5 py-3.5 bg-ink group-hover:bg-[#243A2D] text-white rounded-xl text-[15px] font-black shadow-md shadow-ink/15 group-hover:shadow-lg group-hover:shadow-ink/25 transition-[background-color,box-shadow] duration-200 ease-out">
                                {t.seeSpecial}
