...
export default function WhatsAppFloat() {
    ...
    return (
        <a
            ...
            className="group fixed bottom-5 right-5 md:bottom-7 md:right-7 z-[80] flex items-center justify-center w-14 h-14 md:w-16 md:h-16 rounded-full bg-[#25D366] hover:bg-[#20BE5A] text-white shadow-2xl shadow-[#25D366]/40 hover:scale-110 active:scale-95 transition-all duration-300"
        >
            {/* Pulse ring */}
