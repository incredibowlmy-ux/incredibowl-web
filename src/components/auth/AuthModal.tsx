...
export default function AuthModal({ isOpen, onClose }: { isOpen: boolean, onClose: () => void }) {
    ...
    return (
        <div className="fixed inset-0 z-[120] flex items-center justify-center p-4">
            ...
            <div className="relative w-full max-w-md bg-[#FDFBF7] rounded-3xl shadow-2xl overflow-hidden animate-in zoom-in-95 duration-300 max-h-[90vh] overflow-y-auto">
                {/* Header */}
                <div className="p-8 text-center bg-white border-b border-[#E3EADA] relative">
                    ...
                    <div className="w-20 h-20 mx-auto mb-4 bg-white border-2 border-[#E3EADA] rounded-full flex items-center justify-center overflow-hidden shadow-md">
                        <Image src="/logo.png" alt="Logo" width={96} height={96} className="scale-110" />
                    </div>
