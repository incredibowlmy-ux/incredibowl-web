    ...
    return (
        <div className="fixed inset-0 z-[120] flex items-center justify-center p-4">
            ...
            <div className="relative w-full max-w-sm bg-[#FDFBF7] rounded-3xl shadow-2xl overflow-hidden animate-in zoom-in-95 duration-300 max-h-[90vh] overflow-y-auto">
                {/* Header */}
                <div className="p-6 text-center bg-white border-b border-[#E3EADA] relative">
                    <button onClick={resetAndClose} className="absolute top-4 right-4 p-2 text-gray-400 hover:text-[#1A2D23] transition-colors">
                        <X size={20} />
                    </button>
                    <div className="w-14 h-14 mx-auto mb-3 bg-white border-2 border-[#E3EADA] rounded-full flex items-center justify-center overflow-hidden shadow-md">
                        <Image src="/logo.png" alt="Logo" width={64} height={64} className="scale-110" />
                    </div>
                    <h2 className="text-xl font-black text-[#1A2D23]">Incredibowl</h2>
                    <p className="text-[9px] font-bold text-[#FF6B35] uppercase tracking-widest mt-1">
