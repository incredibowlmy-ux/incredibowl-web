    ...
    return (
        <div className="p-6 space-y-4">
            ...
            <form onSubmit={onSubmit} className="space-y-3">
                ...
                <div className="text-right">
                    <button type="button" onClick={onForgotPassword} disabled={loading}
                        className="text-xs font-bold text-gray-400 hover:text-primary disabled:opacity-50">
                        {t.forgot}
                    </button>
                </div>
            ...
            <div className="text-center space-y-1">
                <button onClick={onSignup} className="text-xs font-bold text-primary hover:underline">{t.noAccount}</button>
                <br />
