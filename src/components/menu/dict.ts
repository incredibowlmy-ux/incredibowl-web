...
export const ADDON_DICT: Record<Locale, AddOnDictShape> = {
    zh: {
        ...
        dateHolidayAlert: '该日碗妈休息，暂停接单，请另选日期。 (We are closed that day — please pick another day.)',
        fixedDateSuffix: '(固定款)',
    ...
    en: {
        ...
        dateHolidayAlert: 'We are closed that day — please pick another day.',
