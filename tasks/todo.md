...
### 克数口径（老板 2026-08-09 当天确认）
标签上的 90g 是**焖后熟重**，采购按 **120g 生萝卜**记（缩水约 25%，与马铃薯
90→100g、柠香鸡胸 150→170g 同一个「宁多勿少」口径）。
⏳ 仍缺：主菜自己的克数（`dishRecipes` 30 号还是空数组 —— 五花肉/白饭/姜葱/
主菜自带白萝卜碗妈都没给），所以备餐汇总现在只算得出加料这部分。
